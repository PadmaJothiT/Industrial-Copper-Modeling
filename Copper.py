...
st.markdown("<h1 style='text-align: center; color: gold;'>WELCOME TO INDUSTRIAL COPPER MODELLING</h1>",unsafe_allow_html=True)
            ...
            if 'PRICE PREDICTION':
                ...
                with c1:
                    ...
                    if st.button('PREDICT PRICE'):
                        ...
                        with open('ExtraTreeRegression.pkl', 'rb') as f:
                            model = pickle.load(f)
